    ...
    public async Task<string> CreatePayPalOrderAsync(decimal amount, string email, string phone)
    {
        ...
        var data = new
        {
            ...
            application_context = new
            {
                ...
                landing_page = "BILLING" // 🔥 Désactive la connexion PayPal et met directement le paiement par carte
            },
            payment_source = new
            {
                card = new
                {
                    ...
                    billing_address = new
                    {
                        ...
                        admin_area_1 = "jubail",
                        postal_code = "10999",
                        country_code = "SA" // 🔥 Doit être un pays qui autorise le mode invité
                    }
                }
            }
        };
        ...
        try
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                var approvalUrl = jsonResponse.links[1].href;
                return approvalUrl;
            }
            else
            {
